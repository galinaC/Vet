    ...
    public partial class clinic : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsultingServices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConsultingServices_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VaccineSchedules_Animals_AnimalId",
                        column: x => x.AnimalId,
                        principalTable: "Animals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VaccineSchedules_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsultingServices_UserId1",
                table: "ConsultingServices",
                column: "UserId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VaccineSchedules_AnimalId",
                table: "VaccineSchedules",
                column: "AnimalId");

            migrationBuilder.CreateIndex(
                name: "IX_VaccineSchedules_UserId1",
                table: "VaccineSchedules",
                column: "UserId1");
