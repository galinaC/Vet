...
namespace Vet.Controllers
{
    public class VaccinesController : Controller
    {
        ...
        public VaccinesController(ClinicDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Vaccines != null ? 
                          ...
                          Problem("Entity set 'ClinicDbContext.Vaccines'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] Vaccine vaccine)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ClinicDbContext.Vaccines'  is null.");
            }
            var vaccine = await _context.Vaccines.FindAsync(id);
            if (vaccine != null)
            {
